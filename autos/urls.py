...
urlpatterns = [
        ...
        path('lookup/create/', views.MakeCreate.as_view(), name='list_create'),
        path('lookup/<int:pk>/update/', views.MakeUpdate.as_view(), name='list_update'),
        path('lookup/<int:pk>/delete/', views.MakeDelete.as_view(), name='list_delete'),
]
